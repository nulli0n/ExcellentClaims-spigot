...
public class LandEditorUIService {

    private final DialogRegistry    dialogs;
    private final LandUIService     coreUI; // used to know how to navigate back to claim menu
    private final LandEditorService editor;

    @Nullable
    private EditorMenus menus;

    public LandEditorUIService(DialogRegistry dialogs, LandUIService coreUI, LandEditorService editor) {
    ...
    public ActionResult openClaimMenu(Player player, LandClaim claim) {
        return this.coreUI.showClaimMenu(player, claim);
    }

    public ActionResult openNameDialog(Player player, LandClaim claim, Runnable callback) {
    ...
    public ActionResult openDescriptionDialog(Player player, LandClaim claim, Runnable callback) {
    ...
    public ActionResult openPriorityDialog(Player player, LandClaim claim, Runnable callback) {
    ...
    public ActionResult openIconSelectionMenu(Player player, LandClaim claim) {
