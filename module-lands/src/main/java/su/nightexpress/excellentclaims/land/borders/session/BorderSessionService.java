...
import su.nightexpress.excellentclaims.land.borders.BorderService;
...
public class BorderSessionService {
    ...
    public ActionResult enableChunkBounds(Player player) {
        ...
        return ActionResult.ok(LandLang.LAND_BOUNDS_ENABLED);
    }
    ...
    public ActionResult disableChunkBounds(Player player) {
        ...
        return ActionResult.ok(LandLang.LAND_BOUNDS_DISABLED);
    }
}
