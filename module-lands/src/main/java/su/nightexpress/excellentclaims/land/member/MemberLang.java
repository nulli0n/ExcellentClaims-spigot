...
public final class MemberLang implements LangContainer {
    ...
    public static final MessageLocale MEMBER_PURGE_SUCCESS = LangEntry.builder("Lands.Member.Purge.Success")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap("You have successfully purged all claim members.")
        );

    public static final MessageLocale MEMBER_PURGE_ALREADY_EMPTY = LangEntry.builder("Lands.Member.Purge.AlreadyEmpty")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap("There is already no members in the claim.")
        );

    public static final MessageLocale MEMBER_ADD_ONLINE_NOTHING = LangEntry.builder("Lands.Member.AddOnline.Nothing")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap("There are no players online that could be members of your claim.")
        );

    public static final MessageLocale MEMBER_ADD_TARGET_IS_OWNER = LangEntry.builder("Lands.Member.Add.TargetIsOwner")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap(TagWrappers.RED.wrap(CommonPlaceholders.PLAYER_NAME) +
                " is the claim owner. You can't add it as a member.")
        );

    public static final MessageLocale MEMBER_ADD_TARGET_IS_MEMBER = LangEntry.builder("Lands.Member.Add.TargetIsMember")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap(TagWrappers.RED.wrap(CommonPlaceholders.PLAYER_NAME) +
                " is already a member of the " + TagWrappers.YELLOW.wrap(LandsPlaceholders.LAND_NAME) + " claim.")
        );

    public static final MessageLocale MEMBER_ADD_SUCCESS = LangEntry.builder("Lands.Member.Add.Success")
        .chatMessage(
            TagWrappers.GRAY.wrap("You added " + TagWrappers.YELLOW.wrap(CommonPlaceholders.PLAYER_NAME) +
                ...
                " to the " + TagWrappers.YELLOW.wrap(LandsPlaceholders.LAND_NAME) + " claim.")
        );

    public static final MessageLocale MEMBER_KICK_TARGET_IS_ABOVE = LangEntry.builder("Lands.Member.Kick.TargetIsAbove")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
    ...
    public static final MessageLocale MEMBER_KICK_TARGET_IS_NOT_MEMBER = LangEntry
        .builder("Lands.Member.Kick.TargetIsNotMember")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap("You can't kick " + TagWrappers.RED.wrap(CommonPlaceholders.PLAYER_NAME) +
                " because it is not a member of your claim.")
        );

    public static final MessageLocale MEMBER_KICK_SUCCESS = LangEntry.builder("Lands.Member.Kick.Success")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap("You have successfully kicked " +
                TagWrappers.GREEN.wrap(CommonPlaceholders.PLAYER_NAME) + " from claim members.")
        );

    public static final MessageLocale MEMBER_PROMOTION_SUCCESS = LangEntry
        .builder("Lands.Member.Promotion.Success")
        .chatMessage(
    ...
    public static final MessageLocale MEMBER_PROMOTION_NOTHING_TO = LangEntry
        .builder("Lands.Member.Promotion.NothingTo")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap(TagWrappers.RED.wrap(CommonPlaceholders.PLAYER_NAME) +
    ...
    public static final MessageLocale MEMBER_DEMOTION_SUCCESS = LangEntry
        .builder("Lands.Member.Demotion.Success")
        .chatMessage(
    ...
    public static final MessageLocale MEMBER_DEMOTION_NOTHING_TO = LangEntry
        .builder("Lands.Member.Demotion.NothingTo")
        .chatMessage(
            Sound.ENTITY_VILLAGER_NO,
            TagWrappers.GRAY.wrap(TagWrappers.RED.wrap(CommonPlaceholders.PLAYER_NAME) +
    ...
    public static final TextLocale UI_DIALOG_ADD_MEMBER_BY_ONLINE_TITLE = LangEntry
        .builder("Lands.UI.Member.Dialog.AddMember.Title")
        .text(
    ...
    public static final DialogElementLocale UI_DIALOG_ADD_MEMBER_BY_ONLINE_BODY = LangEntry
        .builder("Lands.UI.Member.Dialog.AddMember.Body")
        .dialogElement(
            "Click the desired player to add it to claim members."
        );

    public static final ButtonLocale UI_DIALOG_ADD_MEMBER_BY_ONLINE_PLAYER_BUTTON = LangEntry
        .builder("Lands.UI.Member.Dialog.AddMember.PlayerButton")
    ...
    public static final TextLocale UI_DIALOG_PURGE_MEMBERS_TITLE = LangEntry
        .builder("Lands.UI.Member.Dialog.PurgeMembers.Title")
        .text(
    ...
    public static final DialogElementLocale UI_DIALOG_PURGE_MEMBERS_BODY = LangEntry
        .builder("Lands.UI.Member.Dialog.PurgeMembers.Body")
        .dialogElement(
            "Are you sure you want to kick " + TagWrappers.RED.wrap("ALL MEMBERS") +
                " from the " + TagWrappers.YELLOW.wrap(LandsPlaceholders.LAND_NAME) + " claim?"
        );

    public static final TextLocale UI_DIALOG_KICK_MEMBER_TITLE = LangEntry
        .builder("Lands.UI.Member.Dialog.KickMember.Title")
        .text(
    ...
    public static final DialogElementLocale UI_DIALOG_KICK_MEMBER_BODY = LangEntry
        .builder("Lands.UI.Member.Dialog.KickMember.Body")
        .dialogElement(
    ...
    public static final TextLocale UI_DIALOG_RANK_PROMOTION_TITLE = LangEntry
        .builder("Lands.UI.Member.Dialog.RankPromotion.Title")
        .text(
    ...
    public static final DialogElementLocale UI_DIALOG_RANK_PROMOTION_BODY = LangEntry
        .builder("Lands.UI.Member.Dialog.RankPromotion.Body")
        .dialogElement(
            "Select the new rank for " + TagWrappers.WHITE.wrap(CommonPlaceholders.PLAYER_NAME) +
                " in the " + TagWrappers.YELLOW.wrap(LandsPlaceholders.LAND_NAME) + " claim."
        );

    public static final ButtonLocale UI_DIALOG_RANK_PROMOTION_RANK_BUTTON = LangEntry
        .builder("Lands.UI.Member.Dialog.RankPromotion.RankButton")
    ...
    public static final TextLocale UI_DIALOG_RANK_DEMOTION_TITLE = LangEntry
        .builder("Lands.UI.Member.Dialog.RankDemotion.Title")
        .text(
    ...
    public static final DialogElementLocale UI_DIALOG_RANK_DEMOTION_BODY = LangEntry
        .builder("Lands.UI.Member.Dialog.RankDemotion.Body")
        .dialogElement(
            "Select the new rank for " + TagWrappers.WHITE.wrap(CommonPlaceholders.PLAYER_NAME) +
                " in the " + TagWrappers.YELLOW.wrap(LandsPlaceholders.LAND_NAME) + " claim."
        );
    ...
    public static final ButtonLocale UI_DIALOG_RANK_DEMOTION_RANK_BUTTON = LangEntry
        .builder("Lands.UI.Member.Dialog.RankDemotion.RankButton")
        .button(ClaimsPlaceholders.RANK_NAME,
    ...
    /* public static final ButtonLocale UI_DIALOG_ADD_MEMBER_PLAYER_BUTTON_UNSELECTED = LangEntry
        .builder("Lands.UI.Member.Dialog.AddMember.PlayerButton.Unselected")
        .button(ClaimsPlaceholders.GENERIC_ICON + CommonPlaceholders.PLAYER_NAME,
    ...
    public static final ButtonLocale UI_DIALOG_ADD_MEMBER_PLAYER_BUTTON_SELECTED = LangEntry
        .builder("Lands.UI.Member.Dialog.AddMember.PlayerButton.Selected")
        .button(
