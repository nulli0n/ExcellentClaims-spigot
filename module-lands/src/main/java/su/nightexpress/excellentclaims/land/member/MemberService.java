...
import su.nightexpress.excellentclaims.land.member.action.MemberReason;
...
public class MemberService {
    ...
    public MemberService(LandDataService dataService, ClaimPermissionAPI permissions, RanksAPI ranksAPI) {
        this.dataService = dataService;
        this.permissions = permissions;
        this.ranksAPI = ranksAPI;
    }

    public ActionResult canManageMembers(Player staff, LandClaim claim) {
    ...
    public ActionResult canAddMembers(Player staff, LandClaim claim) {
    ...
    public ActionResult canPurgeMembers(Player staff, LandClaim claim) {
    ...
    public ActionResult canKickMember(Player staff, LandClaim claim, ClaimMember member) {
    ...
    public ActionResult canPromote(Player staff, LandClaim claim, ClaimMember member) {
    ...
    public ActionResult canDemote(Player staff, LandClaim claim, ClaimMember member) {
    ...
    public List<Rank> getPromotionRanks(Player staff, LandClaim claim, ClaimMember member) {
    ...
    public List<Rank> getDemotionRanks(Player staff, LandClaim claim, ClaimMember member) {
        boolean adminMode = this.permissions.hasBypass(staff);
    ...
    public ActionResult addMember(Player player, LandClaim claim, UserData user) {
    ...
    public ActionResult purgeMembers(Player player, LandClaim claim) {
    ...
    public ActionResult kickMember(Player player, LandClaim claim, MemberContext context) {
    ...
    public ActionResult promoteMember(Player staff, LandClaim claim, MemberContext context, Rank next) {
        ClaimMember member = context.member();
    ...
    public ActionResult demoteMember(Player staff, LandClaim claim, MemberContext context, Rank prev) {
        ClaimMember member = context.member();
