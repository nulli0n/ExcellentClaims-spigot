...
@NullMarked
public class LandListMenu extends AbstractMenu {

    private static final String DEFAULT_TITLE = "My Land Claims";
    ...
    public LandListMenu(ClaimPlugin plugin,
    ...
    protected void onLoad(FileConfig config) {
        ...
        List<String> landLoreOwner = config.getOrSet("Land.Lore.Owner", ConfigCodecs.STRING_LIST, Lists.newList(
        ...
        List<String> landLoreMember = config.getOrSet("Land.Lore.Member", ConfigCodecs.STRING_LIST, Lists.newList(
        ...
        this.landItemPopulator = ItemPopulator.builder(LandClaim.class)
            ...
            .itemProvider((context, claim) -> {
                ...
                return claim.getIcon()
                    ...
                    .setLore(claim.isOwner(player) ? landLoreOwner : landLoreMember)
                    .hideAllComponents()
                    .replace(ctx -> {
    ...
    public void onPrepare(ViewerContext context, InventoryView view, Inventory inventory, List<MenuItem> items) {
        ...
        List<LandClaim> claims = this.repository.values()
            ...
            .sorted(
                Comparator.comparingInt((LandClaim claim) -> claim.isOwner(player) ? 1 : 0)
                    .reversed()
