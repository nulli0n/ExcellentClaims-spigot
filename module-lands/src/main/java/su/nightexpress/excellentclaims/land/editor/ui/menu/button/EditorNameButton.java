...
public class EditorNameButton implements DefaultButtonExtension {
    ...
    public EditorNameButton(LandEditorService editor, LandEditorUIController controller) {
        this.editor = editor;
    ...
    public void onLayoutDefine(AbstractMenuBase menu) {
        menu.addDefaultButton("land_name", MenuItem.button()
            .defaultState(ItemState.builder()
                .icon(NightItem.fromType(Material.BIRCH_HANGING_SIGN)
                    ...
                    .setLore(Lists.newList(
                        TagWrappers.GRAY.wrap("Current: " + TagWrappers.GOLD.wrap(LandsPlaceholders.LAND_NAME)),
                        "",
                ...
                .displayModifier((context, item) -> {
                    item.replace(builder -> builder.with(context.getObject(LandClaim.class).placeholders()));
                })
