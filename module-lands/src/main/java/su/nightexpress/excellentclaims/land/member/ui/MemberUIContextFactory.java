...
public class MemberUIContextFactory {
    ...
    public void createMembersContext(LandClaim claim, Consumer<MemberListUIContext> callback) {
    ...
    public OnlineMemberContext createOnlineMembersContext(LandClaim claim) {
