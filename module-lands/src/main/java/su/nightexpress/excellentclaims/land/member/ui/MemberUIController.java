...
public class MemberUIController {
    ...
    public void openMembersMenu(Player player, LandClaim claim) {
    ...
    public void onBackClick(Player player, LandClaim claim) {
        this.uiService.showMainMenu(player, claim).handleFeedback((locale, ctx) -> {
            this.dispatcher.send(locale, player, ctx);
        });
    }

    public void onMemberClick(Player player, LandClaim claim, ClaimMember member, UserData userData) {
    ...
    public void onAddOnlineMemberClick(Player player, LandClaim claim, @Nullable Runnable callback) {
    ...
    public void onSelectMemberToAdd(Player player, LandClaim claim, UUID playerId) {
    ...
    public void onPurgeMembersClick(Player player, LandClaim claim, @Nullable Runnable callback) {
        this.uiService.showMemberPurgeDialog(player, claim, callback).handleFeedback((locale, ctx) -> {
            this.dispatcher.send(locale, player, ctx);
        });
    }

    public void onPurgeMembersConfirm(Player player, LandClaim claim) {
        this.memberService.purgeMembers(player, claim).handleFeedback((locale, ctx) -> {
            this.dispatcher.send(locale, player, ctx);
        });
    }

    public void onPromoteMemberClick(Player player, LandClaim claim, MemberActionUIContext context,
    ...
    public void onPromotionRankSelect(Player player, LandClaim claim, MemberContext context, Rank rank) {
        this.memberService.promoteMember(player, claim, context, rank).handleFeedback((locale, ctx) -> {
            this.dispatcher.send(locale, player, ctx);
        });
    }

    public void onDemoteMemberClick(Player player, LandClaim claim, MemberActionUIContext context,
                                    @Nullable Runnable callback) {
        ClaimMember member = context.memberContext().member();
    ...
    public void onDemotionRankSelect(Player player, LandClaim claim, MemberContext context, Rank rank) {
        this.memberService.demoteMember(player, claim, context, rank).handleFeedback((locale, ctx) -> {
            this.dispatcher.send(locale, player, ctx);
        });
    }

    public void onKickMemberClick(Player player, LandClaim claim, MemberActionUIContext context,
                                  @Nullable Runnable callback) {
    ...
    public void onKickMemberConfirm(Player player, LandClaim claim, MemberContext context) {
