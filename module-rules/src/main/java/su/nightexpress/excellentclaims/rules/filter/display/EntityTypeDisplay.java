...
@NullMarked
public class EntityTypeDisplay implements ElementDisplay<EntityType> {

    public static final EntityTypeDisplay INSTANCE = new EntityTypeDisplay();

    @Override
    public String getNameLocalized(EntityType type) {
        return LangUtil.getSerializedName(type);
    }

    @Override
    public @Nullable String getSpriteTag(EntityType type) {
        Material material = getEntityIcon(type);
        if (material == null) return null;

        return TagWrappers.SPRITE_ITEM.apply(material);
    }
    ...
    private static @Nullable Material getEntityIcon(EntityType type) {
        ...
        return switch (type) {
            ...
            case SPAWNER_MINECART -> Material.SPAWNER;
    ...
    /* private static Material getEntityIcon(EntityType type) {
        return switch (type) {
            ...
            case GLOW_SQUID -> NightItem.asCustomHead(
                "55e2b46e52ac92d419a2ddbcc9cdce7b451cb48ae739d85d607db0502a008ce0");
            case PUFFERFISH -> NightItem.asCustomHead(
                "6df8c316962949ba3be445c94ebf714108252d46459b66110f4bc14e0e1b59dc");
            case TROPICAL_FISH -> NightItem.asCustomHead(
            ...
            case ELDER_GUARDIAN -> NightItem.asCustomHead(
                "30f868caf19cf2124f0fef98e6b8773d27fbf42d93aab06b22ee033b2aee6447");
            case ARMOR_STAND -> Material.ARMOR_STAND);
            ...
            case ARMADILLO -> NightItem.asCustomHead(
            ...
            case HAPPY_GHAST -> NightItem.asCustomHead( "f7e12a5959992ce153ced236aa6732396531834d00f283bce1952d04f3591d99");
            ...
            case MOOSHROOM -> NightItem.asCustomHead(
                "a163bc416b8e6058f92b231e9a524b7fe118eb6e7eeab4ad16d1b52a3ec04fcd");
            ...
            case PIGLIN_BRUTE -> NightItem.asCustomHead(
            ...
            case POLAR_BEAR -> NightItem.asCustomHead(
            ...
            case SILVERFISH -> NightItem.asCustomHead(
            ...
            case SKELETON_HORSE -> NightItem.asCustomHead(
                "72618a3c268ca388a38b893016aba26f6271519cde1a6bbd599cdd6472843b7f");
            ...
            case TRADER_LLAMA -> NightItem.asCustomHead(
            ...
            case VINDICATOR -> NightItem.asCustomHead(
                "6deaec344ab095b48cead7527f7dee61b063ff791f76a8fa76642c8676e2173");
            case WANDERING_TRADER -> NightItem.asCustomHead(
                "499d585a9abf59fae277bb684d24070cef21e35609a3e18a9bd5dcf73a46ab93");
            ...
            case WITHER_SKELETON -> NightItem.asCustomHead(
                "7953b6c68448e7e6b6bf8fb273d7203acd8e1be19e81481ead51f45de59a8");
            ...
            case ZOMBIE, GIANT -> NightItem.asCustomHead(
                "64528b3229660f3dfab42414f59ee8fd01e80081dd3df30869536ba9b414e089");
            case ZOMBIE_HORSE -> NightItem.asCustomHead(
                "171ce469cba4426c811f69be5d958a09bfb9b1b2bb649d3577a0c2161ad2f524");
            case ZOMBIE_VILLAGER -> NightItem.asCustomHead(
                "8c7505f224d5164a117d8c69f015f99eff434471c8a2df907096c4242c3524e8");
            case ZOMBIFIED_PIGLIN -> NightItem.asCustomHead(
