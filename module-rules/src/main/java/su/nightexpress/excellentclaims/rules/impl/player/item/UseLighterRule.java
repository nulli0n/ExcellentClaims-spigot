...
@NullMarked
public class UseLighterRule extends BasePlayerUseItemRule {

    public UseLighterRule(ClaimPermissionAPI permissions) {
        super(permissions);
    }
