...
@NullMarked
public class DropItemsRule extends SimpleSpec<ItemDropContext, Boolean> {

    private final ClaimPermissionAPI permissions;

    public DropItemsRule(ClaimPermissionAPI permissions) {
        super(ItemDropContext.class, RuleTypes.BOOLEAN, RuleCategory.PLAYER);
        this.permissions = permissions;
    }

    @Override
    public RuleBehavior<ItemDropContext, Boolean> createBehavior() {
