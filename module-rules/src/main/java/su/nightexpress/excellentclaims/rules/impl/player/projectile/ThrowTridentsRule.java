...
@NullMarked
public class ThrowTridentsRule extends BasePlayerProjectileLaunchRule {

    @Override
    protected boolean shouldHandle(ProjectileLaunchEvent event, Projectile projectile) {
        return projectile.getType() == EntityType.TRIDENT;
    }

    @Override
    public RuleDefinition getDefaultDefinition() {
        return RuleDefinition.builder("Throw Tridents")
            .description(
                "Controls whether outsiders",
                "can throw tridents here."
            )
