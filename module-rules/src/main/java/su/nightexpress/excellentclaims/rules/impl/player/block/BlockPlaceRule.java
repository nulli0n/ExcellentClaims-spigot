...
@NullMarked
public class BlockPlaceRule extends SimpleSpec<BlockPlaceContext, Boolean> {

    private final ClaimPermissionAPI permissions;

    public BlockPlaceRule(ClaimPermissionAPI permissions) {
        super(BlockPlaceContext.class, RuleTypes.BOOLEAN, RuleCategory.PLAYER);
        this.permissions = permissions;
    }

    @Override
    public RuleBehavior<BlockPlaceContext, Boolean> createBehavior() {
