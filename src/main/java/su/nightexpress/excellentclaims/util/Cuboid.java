...
//        return true;
    ...
    private Collection<ChunkPos> getIntersectingChunks() {
        ...
        int minX = NumberConversions.floor(this.min.getX()) >> 4;
        int maxX = NumberConversions.floor(this.max.getX()) >> 4;
        int minZ = NumberConversions.floor(this.min.getZ()) >> 4;
        int maxZ = NumberConversions.floor(this.max.getZ()) >> 4;
