...
import static su.nightexpress.excellentclaims.Placeholders.SKIN_CHECK_MARK;
import static su.nightexpress.excellentclaims.Placeholders.SKIN_WRONG_MARK;
import static su.nightexpress.nightcore.util.text.tag.Tags.*;

@SuppressWarnings("UnstableApiUsage")
public class ConfirmMenu extends LinkedMenu<ClaimPlugin, Confirmation> implements ConfigBased {
