...
public class EditorHomeButton implements DefaultButtonExtension {
    ...
    public EditorHomeButton(WildernessEditorService editor, WildernessEditorUIController controller) {
        this.editor = editor;
    ...
    public void onLayoutDefine(AbstractMenuBase menu) {
        menu.addDefaultButton("wilderness_spawn", MenuItem.button()
            .defaultState(ItemState.builder()
                .icon(NightItem.fromType(Material.ENDER_PEARL)
                    ...
                    .setLore(Lists.newList(
                        TagWrappers.GRAY.wrap("Teleport to wilderness's spawn location."),
                        "",
