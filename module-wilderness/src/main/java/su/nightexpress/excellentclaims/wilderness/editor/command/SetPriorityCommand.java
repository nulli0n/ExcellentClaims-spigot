...
public class SetPriorityCommand implements CommandExtension {
    ...
    public SetPriorityCommand(WildernessCommandResolver resolver,
    ...
    public ExecutableNode createCommand() {
        return Commands.literal("priority", builder -> builder
            .playerOnly()
            .description(WildernessLang.COMMAND_WILDERNESS_SET_PRIORITY_DESC)
            .permission(WildernessPerms.COMMAND_SET_PRIORITY)
            .withArguments(
