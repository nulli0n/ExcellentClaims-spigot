...
public class EditorPriorityButton implements DefaultButtonExtension {
    ...
    public EditorPriorityButton(WildernessEditorService editor, WildernessEditorUIController controller) {
        this.editor = editor;
    ...
    public void onLayoutDefine(AbstractMenuBase menu) {
        menu.addDefaultButton("wilderness_priority", MenuItem.button()
                ...
                .icon(NightItem.fromType(Material.REPEATER)
                    ...
                    .setLore(Lists.newList(
                        TagWrappers.GRAY.wrap("Current: " + TagWrappers.GOLD.wrap(
                            WildernessPlaceholders.WILDERNESS_PRIORITY)),
                        "",
