package su.nightexpress.excellentclaims.wilderness.editor.ui.menu;
...
@NullMarked
public class EditorIconSelectionMenu extends AbstractObjectMenu<WildernessRegion> {
    ...
    public EditorIconSelectionMenu(ClaimPlugin plugin, WildernessEditorUIController controller) {
        super(plugin, MenuType.HOPPER, DEFAULT_TITLE, WildernessRegion.class);
    ...
    private void handlePlayerShiftClick(ViewerContext context, InventoryClickEvent event) {
        ...
        WildernessRegion claim = this.getObject(context);
