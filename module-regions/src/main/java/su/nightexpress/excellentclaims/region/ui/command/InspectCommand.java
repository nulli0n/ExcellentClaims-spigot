...
import su.nightexpress.excellentclaims.region.ui.RegionUIContextFactory;
...
public class InspectCommand implements CommandExtension {
    ...
    private final RegionUIContextFactory uiContextFactory;
    private final MessageDispatcher      dispatcher;

    public InspectCommand(RegionUIService uiService,
                          RegionUIContextFactory uiContextFactory,
    ...
    public ExecutableNode createCommand() {
        return Commands.literal("inspect", builder -> builder
            .playerOnly()
            .description(RegionLang.COMMAND_REGION_INSPECT_DESC)
            .permission(RegionPerms.COMMAND_INSPECT)
