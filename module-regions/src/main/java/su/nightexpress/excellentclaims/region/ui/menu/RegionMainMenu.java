...
@NullMarked
public class RegionMainMenu extends AbstractObjectMenu<RegionClaim> {

    private static final String DEFAULT_TITLE = "[%s] Menu"
        .formatted(RegionsPlaceholders.REGION_NAME);

    private final RegionUIService uiService;

    public RegionMainMenu(ClaimPlugin plugin, RegionUIService uiService) {
        super(plugin, MenuType.GENERIC_9X6, DEFAULT_TITLE, RegionClaim.class);
