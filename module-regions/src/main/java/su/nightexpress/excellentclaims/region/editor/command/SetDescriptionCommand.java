...
public class SetDescriptionCommand implements CommandExtension {
    ...
    public SetDescriptionCommand(RegionCommandResolver resolver,
    ...
    public ExecutableNode createCommand() {
        return Commands.literal("description", builder -> builder
            .playerOnly()
            .description(RegionLang.COMMAND_REGION_SET_DESCRIPTION_DESC)
            .permission(RegionPerms.COMMAND_SET_DESCRIPTION)
            .withArguments(
