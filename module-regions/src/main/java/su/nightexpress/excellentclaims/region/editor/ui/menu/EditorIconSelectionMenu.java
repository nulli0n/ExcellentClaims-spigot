package su.nightexpress.excellentclaims.region.editor.ui.menu;
...
@NullMarked
public class EditorIconSelectionMenu extends AbstractObjectMenu<RegionClaim> {
    ...
    public EditorIconSelectionMenu(ClaimPlugin plugin, RegionEditorUIController controller) {
        super(plugin, MenuType.HOPPER, DEFAULT_TITLE, RegionClaim.class);
    ...
    private void handlePlayerShiftClick(ViewerContext context, InventoryClickEvent event) {
        ...
        RegionClaim claim = this.getObject(context);
