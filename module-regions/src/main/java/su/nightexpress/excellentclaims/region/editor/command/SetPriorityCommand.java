...
public class SetPriorityCommand implements CommandExtension {
    ...
    public SetPriorityCommand(RegionCommandResolver resolver,
    ...
    public ExecutableNode createCommand() {
        return Commands.literal("priority", builder -> builder
            .playerOnly()
            .description(RegionLang.COMMAND_REGION_SET_PRIORITY_DESC)
            .permission(RegionPerms.COMMAND_SET_PRIORITY)
            .withArguments(
