...
public class BorderService {
    ...
    public void highlightBorders(Player player, ChunkPos chunkPos, BorderSession session) {
        ...
        RegionClaim land = null; // TODO this.repository.getPrioritizedClaim(world, chunkPos);
    ...
    private Color getBlockColor(Player player, @Nullable RegionClaim land, boolean overlaps) {
        if (land != null) {
