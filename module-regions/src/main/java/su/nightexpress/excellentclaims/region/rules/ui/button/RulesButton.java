package su.nightexpress.excellentclaims.region.rules.ui.button;
...
public class RulesButton implements DefaultButtonExtension {
    ...
    private final RegionRuleUIController controller;

    public RulesButton(RegionRuleUIService service, RegionRuleUIController controller) {
